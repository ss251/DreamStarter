...
contract DreamStarterCollab is Context, ERC721Enumerable, ReentrancyGuard {
    ...
    modifier onlyProposalCreator() {
        require(
            ...
            "DreamStarterCollab: User is not proposal creator"
        );
        _;
    }
    ...
    modifier onlyWhenProposalIsNotActive() {
        require(
            ...
            "DreamStarterCollab: Funding has been intiated , action cannot be performed"
        );
        _;
    }
    modifier onlyWhenNotPaused() {
        require(pause == false, "DreamStarterCollab: Funding is paused!");
        _;
    }
    ...
    function intiateRejection() external {
        require(
            ...
            "DreamStarterCollab: Rejection cannot be done"
        );
        _proposalRejection();
    ...
    function mintTicket() external returns (uint256) {
        ...
        require(
            block.timestamp >= fundingActiveTime &&
                block.timestamp < fundingEndTime,
            "DreamStarterCollab: Funding time has been passed"
        );
        ...
        require(
            fundsInReserve < crowdFundingGoal,
            "DreamStarterCollab: Funding goal has been reached"
        );
    ...
    function withdrawFunds(
        ...
        require(
            ...
            "DreamStarterCollab: Process cannot proceed , less than reserve fund"
        );
        fundsInReserve -= amount;
        _pause();
