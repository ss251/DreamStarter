...
import { DreamStarterCollab , MyToken , AccessMaster} from "../typechain-types"
...
import { Address } from "cluster"
    ...
    describe("DreamStarter Collab,Without Staking", () => {
        ...
        let dreamstarter: DreamStarterCollab
        let token : MyToken
        ...
        before(async () => {
            ...
            let  DreamStarterFactory = await ethers.getContractFactory("DreamStarterCollab")
        ...
        describe("Without Staking ",async () =>{
            ...
            it("Set Time By Proposal Creator and Stake",async() =>{
                ...
                expect(dreamstarter.mintTicket()).to.be.revertedWith("DreamStarterCollab__ProposalRejected()");
             
                expect(dreamstarter.mintTicket()).to.be.revertedWith("DreamStarterCollab: Proposal is being rejected")
    ...
    describe("DreamStarter Collab ,WithStaking Without Crowfunding Goal Reached", () => {
        ...
        it("Intiate Proposal rejection",async() => {
            ...
            expect(dreamstarter.claimback(2)).to.be.revertedWith("DreamStarterCollab_ClaimedNotPossible()")
            expect(dreamstarter.mintTicket()).to.be.revertedWith("DreamStarterCollab: Funding time has been passed")
